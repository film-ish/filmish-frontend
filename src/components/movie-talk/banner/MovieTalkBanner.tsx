...
const MovieTalkBanner = () => {
    return (
      <div className="flex flex-col my-[80px] py-auto gap-4 items-center justify-center bg-white/15 backdrop-blur-50 rounded-2xl text-white relative">
        <div className="z-10 flex flex-col items-center w-full my-[80px]">
          <h1 className="text-[64px] font-bold mb-[10px]">영화인<span className="text-gray-6 text-[66px]" style={{ WebkitTextStroke: '0.3px #fff' }}>과의 대화를 시작하세요</span></h1>
          <h3 className="text-[36px] font-semibold mb-[20px] text-center">독립 영화 팬이라면, 좋아하는 배우나 감독을 더 깊이 알아가고 싶지 않나요?</h3>
