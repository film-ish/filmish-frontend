...
const ReviewDetailPage = () => {
  ...
  const { comments, getMoreComments, createComment, updateComment, deleteComment, deleteCocomment } =
    useComment(reviewId);
  ...
  return (
    <div
      ...
      <div
        className="movie-detail-scrollbar relative w-full flex flex-col gap-4 p-6 pt-0 pb-10 bg-gray-7 rounded-tl-[10px]"
        ...
        <div className="w-full flex flex-col gap-4">
          <div className="text-label-lg font-bold">댓글 {comments?.pages[0]?.content?.length.toLocaleString()}개</div>
          <CommentForm
