...
const DetailPage = () => {
  ...
  return (
    <div className="flex flex-col gap-10 text-paragraph-md">
      <StillcutViewer stillcuts={movie.stillcuts} startIndex={movie.posters?.length > 1 ? 0 : 1} />
      ...
      <section className="flex gap-8">
        {actors.length > 0 && <MakerList title="출연진" makers={actors} />}
        {directors.length > 0 && <MakerList title="감독" makers={directors} />}
      </section>
    </div>
  );
};
